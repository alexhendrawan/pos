...
@section("title")
Retur Pembelian Line
@endsection
@section("content")
<div class="page-content-wrapper">
	<div class="container-fluid">
		<section class=" table-responsive">
			<form action="{{url('/')}}/retur-pembelian-line/{{$data->id}}" method="post">
				@csrf
				@method("put")
				...
				<div class="form-group">
					Harga Retur:
					<input autocomplete="off" type="number" name="returprice" id="var10" class="form-control"
						value="{{$data->retur_price}}">
				</div>
				<div class="form-group">
					QTY Retur:
