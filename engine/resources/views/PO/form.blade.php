...
<div class="page-content-wrapper">
	<div class="container-fluid">
		<form action="{{url('/')}}/po" method="post">
			...
			<div class="form-group hide">
				Total Dibayar:
				<input autocomplete="off" value="0" type="hidden" maxlength="10" name="gt" class="form-control"
					required="">
			</div>
			...
			<div class="form-group">
				<input autocomplete="off" type="submit" onsubmit="check();" class="form-control btn btn-info dis"
					value="Create">
			</div>
				...
				<div class="box col-md-12">
					...
					<div class="col-md-12 col-xs-12">
						...
						<div class="form-group">
							...
							<input type="hidden" class="form-control pricepersatuan">
						</div>
    ...
    $(window).keydown(function(event){
        if(event.keyCode == 13) {
            if($("#var5").val() !=0){
				...
				container.appendChild(input);
				var total = parseInt($("#var5").val()) + parseInt($(".pricepersatuan").val());
				$(".gt").val($(".gt").val()+total);
                $(".count").val(count);
