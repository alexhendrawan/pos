...
<section class="">
	<htmlpageheader name="page-header">
		<h1 style="text-align: center; font-size: 20px;">Faktur Retur Penjualan</h1>
		<br>
		</htmlpageheader>
		<div class="col-md-12" style="display: inline; margin-top: 0px; margin-bottom: 0px;height: 60vh;">
			...
			<table class="table no-border" style="text-align:left; ">
				...
				<tr>
					...
					<td> {{$data->sales->sales->intnomorsales}} / {{$data->no_invoice}}</td>
					<td class="tg-yw4l"></td>
					<td class="tg-yw4l"></td>
					<td></td>
					<td>Kepada Yth.</td>
				...
				<tr>
					...
					<td> {{date("d-m-Y",strtotime($data->sales->sales->createdOn))}}</td>
					<td class="tg-yw4l"></td>
					<td class="tg-yw4l"></td>
					<td></td>
					<td>{{$data->sales->sales->customer->name}}</td>
				</tr>
				<tr>
					<td class="tg-yw4l" style="width: 100px;">Sales</td>
					<td class="tg-yw4l">{{$data->sales->sales->customer->sales->displayName ?? $data->sales->sales->customer->sales->username}}</td>
					<td class="tg-yw4l"></td>
					<td class="tg-yw4l"></td>
					<td class="tg-yw4l"></td>
					<td>{{$data->sales->sales->customer->customer_address}}</td>
				</tr>

				<tr>
					<td style="width: 100px;">Supir/Kenek</td>
					<td>{{$data->sales->staff1->username ?? null}}/{{$data->sales->staff2->username ?? null}}</td>
					<td class="tg-yw4l"></td>
					<td class="tg-yw4l"></td>
			...
			<tr >
				...
				<td style="width:auto">
					<span style="float:right">{{number_format(($key->returprice))}}</span>
				</td>
				<td style="width:auto">
				...
				<td style="width:200px; border:none">
					<span style="float:right;margin-right: 7px;">{{number_format($key->qty*($key->returprice))}}</span>
		...
		<td  style="border-top: solid 2px black; border-bottom:none; font-weight:800; text-align:right">
			Rp. {{number_format($data->sales->sales->total_sales)}}
		</td>
	</tr>
</table>
