    ...
    <section class=" table-responsive">
      ...
      <table id="tabel" class="table table-bordered table-hover box">
        <thead>
          ...
          @if((Session()->get("user")->id == 69 ||Session()->get("user")->id == 70 ||Session()->get("user")->id == 48||Session()->get("user")->id == 36||Session()->get("user")->id == 18)&&($key->kategori->name =="Gaji" || $key->kategori->name =="Komisi" || $key->kategori->name =="Thr"))
          ...
          <tr>
            ...
            <td>{{$key->no_bukti ?? "-"}}</td>
            <td>{{$key->inventoris->name ?? $key->user->displayName ?? "-"}}</td>
