		...
		<section class=" table-responsive">
			<form method="post" action="" id="formlaporan" class="col-md-12" target="_blank">
				...
				<div id="barang" class="paramhide" style="display: none">
					<div class="form-group">
						Kategori:
						<select autocomplete="off" class="resetparam select2-selection__clear category form-control"
							name="kategori" style="width: 100%"></select>
					</div>

					<div class="form-group">
						Merk:
						<select autocomplete="off" class="resetparam select2-selection__clear brands form-control"
							name="merk" style="width: 100%"></select>
					</div>
					<div class="form-group">
						Tampilkan harga:
				...
				<div id="stock" class="paramhide" style="display: none">
					...
					<div class="form-group">
						Supplier:
						<select autocomplete="off" class="resetparam select2-selection__clear supplier form-control"
							name="supplier" style="width: 100%"></select>
					</div>

					<div class="form-group">
						Konsumen:
						<select autocomplete="off" class="resetparam select2-selection__clear customer form-control"
							name="customer" style="width: 100%"></select>
					</div>

					<div class="form-group">
						Gudang:
						<select autocomplete="off" class="resetparam select2-selection__clear warehouse form-control"
							name="warehouse_id" style="width: 100%"></select>
					</div>
				...
				<div id="penjualan" class="paramhide" style="display: none">
					...
					<div class="form-group">
						Barang:
						<select class="resetparam select2-selection__clear stock form-control" name="item_stock"
							style="width: 100%"></select>
					</div>

					<div class="form-group">
						Konsumen:
						<select class="resetparam select2-selection__clear customer form-control" name="customer"
							style="width: 100%"></select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						Sales:
						<select class="resetparam select2-selection__clear sales form-control" name="sales"
							style="width: 100%"></select>
					</div>
				...
				<div id="pembelian" class="paramhide" style="display: none">
					...
					<div class="form-group">
						Barang:
						<select class="resetparam select2-selection__clear inventory form-control" name="itemstock"
							style="width: 100%"></select>
					</div>
					<div class="form-group">
						Supplier:
						<select class="resetparam select2-selection__clear supplier form-control" name="supplier"
							style="width: 100%"></select>
					</div>
				...
				<div id="pengeluaran" class="paramhide" style="display: none">
					...
					<div class="form-group">
						Pegawai:
						<select class="resetparam select2-selection__clear userall form-control" name="pegawai"
							style="width: 100%"></select>
						Inventaris:
						<select class="resetparam select2-selection__clear form-control inventaris" name="inventaris"
							style="width: 100%"></select>
						Kategori Pengeluaran:
						@if(Session()->get("user")->id == 69 ||Session()->get("user")->id == 70
						||Session()->get("user")->id == 48||Session()->get("user")->id
						==
						36||Session()->get("user")->id == 18)
						Kategori
						<select class="form-control katpengadmin resetparam select2-selection__clear"
							name="kategori_pengeluaran_id" style="width: 100%"></select>
						@else
						Kategori
						<select class="form-control katpeng resetparam select2-selection__clear"
							name="kategori_pengeluaran_id" style="width: 100%"></select>
						@endif
					</div>
...
<script type="text/javascript">
	$("#reset").on('click', function(e){
			$(".resetparam select2-selection__clear").val('').trigger('change');
		});
		$('.brands').select2({
			allowClear: true,
			selectOnClose: true,
