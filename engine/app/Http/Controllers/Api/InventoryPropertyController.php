...
use App\InventoryProperty as MD;
...
class InventoryPropertyController extends Controller
{
    ...
    function getbyIdItem($item_id){
        $data = MD::where("item_id","=",$item_id)->first();
        $data["item"]=$data->item;
    ...
    function searchByName($name){
        $data = MD::select("inventory_property.*","item.item_name")
